        ...
        <template #header>
          <div class="flex items-center justify-between px-4 pb-0">
            <div class="flex items-center space-x-2">
              ...
              <div>
                <h3 class="text-lg font-bold text-gray-800">Nạp Code Point Thành Công</h3>
        ...
        <div class="p-4 pt-2 relative overflow-hidden">
          ...
          <div class="text-center mb-6">
            ...
            <div class="relative">
              ...
              >
                <span class="text-4xl font-bold bg-gradient-to-r from-green-500 to-emerald-500 bg-clip-text text-transparent">
          ...
          <div class="bg-gradient-to-r from-blue-50 to-green-50 rounded-xl p-4 mb-4 border border-green-200">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-2">
              ...
              <div class="balance-counter" :class="{ 'animate-counter': animateAmount }">
          ...
          <div class="bg-gray-50 rounded-lg p-4 mb-4">
            <h4 class="text-sm font-semibold text-gray-800 mb-3">Chi tiết giao dịch</h4>
            <div class="space-y-2 text-xs">
              <div class="flex justify-between">
                <span class="text-gray-600">Mã giao dịch:</span>
                <div class="flex items-center space-x-1">
                  <span class="font-mono text-gray-800">{{ transactionId }}</span>
                  <Copy class="w-3 h-3 text-gray-500 cursor-pointer hover:text-gray-700" @click="copyTransactionId" />
                </div>
              </div>
              <div class="flex justify-between">
          ...
          <div class="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-3 mb-4">
            <div class="flex items-start space-x-2">
              ...
              <div class="text-xs text-green-800">
                ...
                <p>Code Point đã được cộng vào tài khoản của bạn. Bạn có thể sử dụng ngay để mua các dịch vụ trên hệ thống.</p>
              </div>
            </div>
          </div>
