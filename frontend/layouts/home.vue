          ...
          <div class="container mx-auto px-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div class="text-center">
                ...
                <div class="text-sm text-gray-600">Dự án active</div>
              </div>
              ...
              <div class="text-center">
                ...
                <div class="text-sm text-gray-600">IT Freelancer</div>
              </div>
              ...
              <div class="text-center">
                ...
                <div class="text-sm text-gray-600">Công ty tin cậy</div>
              </div>
              ...
              <div class="text-center">
                ...
                <div class="text-3xl font-semibold text-gray-900 mb-1">98%</div>
