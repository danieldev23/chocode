...
export const CategoryApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    categoryControllerFindAll: async (
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    categoryControllerFindOne: async (
      id: string,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/category/{id}`.replace(
        `{${"id"}}`,
     ...
     * @throws {RequiredError}
     */
    categoryControllerRemove: async (
      id: string,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await CategoryApiAxiosParamCreator(
        configuration
      ).categoryControllerCreate(body, options);
      return (
    ...
    async categoryControllerFindAll(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => Promise<AxiosResponse<CategoryAllResponse>>
    > {
      const localVarAxiosArgs = await CategoryApiAxiosParamCreator(
        configuration
...
export class CategoryApi extends BaseAPI {
   ...
   */
  public async categoryControllerCreate(
    body: CategoryCreateRequest,
    options?: AxiosRequestConfig
  ): Promise<AxiosResponse<void>> {
   ...
   * @memberof CategoryApi
   */
  public async categoryControllerFindAll(
    options?: AxiosRequestConfig
  ): Promise<AxiosResponse<CategoryAllResponse>> {
    return CategoryApiFp(this.configuration)
      .categoryControllerFindAll(options)
   ...
   * @memberof CategoryApi
   */
  public async categoryControllerFindOne(
    id: string,
    options?: AxiosRequestConfig
  ): Promise<AxiosResponse<void>> {
    return CategoryApiFp(this.configuration)
