...
export const AdminApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    adminControllerCreateNotification: async (
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          "body",
          "Required parameter body was null or undefined when calling adminControllerCreateNotification."
        );
      }
...
export const AdminApiFp = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async adminControllerCreateNotification(
      body: CreateNotificationDto,
      options?: AxiosRequestConfig
    ): Promise<
    ...
    > {
      const localVarAxiosArgs = await AdminApiAxiosParamCreator(
        configuration
      ).adminControllerCreateNotification(body, options);
      return (
...
export class AdminApi extends BaseAPI {
   ...
   * @memberof AdminApi
   */
  public async adminControllerCreateNotification(
    body: CreateNotificationDto,
    options?: AxiosRequestConfig
  ): Promise<AxiosResponse<void>> {
